...
std::string_view DebugPrint(Message::Type msgType)
{
  ...
  case Message::Type::SetFollowingModeFrameRate: return "SetFollowingModeFrameRate";
  case Message::Type::SetNavigationDeadband: return "SetNavigationDeadband";
  case Message::Type::SetLowPowerNavigationMode: return "SetLowPowerNavigationMode";
