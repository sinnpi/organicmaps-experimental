...
{
  private static final float RANGE_EPS = 0.001f;
  ...
  {
    assertArrayEquals(new float[] {50f, 300f}, ElevationChartUtils.computeAltitudeRange(profile(), 0f, 4000f),
                      RANGE_EPS);
  }
  ...
  public void interpolatesBothEdgesOfAWindowInsideOneSegment()
  {
    ...
    assertArrayEquals(new float[] {125f, 175f}, ElevationChartUtils.computeAltitudeRange(profile(), 250f, 750f),
                      RANGE_EPS);
  }
  ...
  public void includesPeaksInsideTheWindow()
  {
    ...
    assertArrayEquals(new float[] {225f, 300f}, ElevationChartUtils.computeAltitudeRange(profile(), 1500f, 2500f),
                      RANGE_EPS);
  }
  ...
  {
    assertArrayEquals(new float[] {50f, 150f}, ElevationChartUtils.computeAltitudeRange(profile(), 3000f, 9000f),
                      RANGE_EPS);
  }
  ...
  public void handlesDegenerateInput()
  {
    ...
    assertArrayEquals(new float[] {42f, 42f}, ElevationChartUtils.computeAltitudeRange(single, 0f, 5000f), RANGE_EPS);
  }
